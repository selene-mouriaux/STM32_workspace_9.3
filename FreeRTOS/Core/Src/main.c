...
osThreadId_t thread_red_led_handler;
const osThreadAttr_t thread_red_led_attributes = {
		.name = "thread_red_led_handler",
		.priority = (osPriority_t) osPriorityNormal,
		.stack_size = 128 * 4
};

osThreadId_t thread_blue_led_handler;
const osThreadAttr_t thread_blue_led_attributes = {
		.name = "thread_blue_led_handler",
		.priority = (osPriority_t) osPriorityNormal,
		.stack_size = 128 * 4
};

osThreadId_t thread_green_led_handler;
const osThreadAttr_t thread_green_led_attributes = {
		.name = "thread_green_led_handler",
		.priority = (osPriority_t) osPriorityNormal,
		.stack_size = 128 * 4
};
...
int main(void)
{
	...
	thread_red_led_handler = osThreadNew (thread_red_led, NULL, &thread_red_led_attributes);
	thread_blue_led_handler = osThreadNew (thread_blue_led, NULL,&thread_blue_led_attributes);
	thread_green_led_handler = osThreadNew (thread_green_led, NULL,&thread_green_led_attributes);
